El módulo contiene el desarrollo para añadir un nuevo modelo account_invoice_mail_followers_extra que está disponible en Odoo desde el apartado Ventas > Ventas > Seguidores extra facturas
